...
namespace individualProject
{
    public partial class lab430 : Form
    {
        ...
        {
            //when the printer label is clicked, check if it was available or not, then set it to the opposite
            if(printer.Text.Equals("Printer: Available"))
            {
                string sql = "UPDATE lab SET printer=0 WHERE room = 430;";
                MySqlConnection con = new MySqlConnection("host=csdatabase.eku.edu;user=naegle;password=NLHFQB;database=naegle;SslMode=none");
                MySqlCommand cmd = new MySqlCommand(sql, con);
                try
                {
                ...
                printer.Text = "Printer: Unavailble";
            }
            else
            {
                string sql = "UPDATE lab SET printer=1 WHERE room = 430;";
                MySqlConnection con = new MySqlConnection("host=csdatabase.eku.edu;user=naegle;password=NLHFQB;database=naegle;SslMode=none");
                MySqlCommand cmd = new MySqlCommand(sql, con);
                try
                {
        ...
        {
            //when the projector label is clicked, check if it was available or not, then set it to the opposite
            if (projector.Text.Equals("Projector: Available"))
            {
                string sql = "UPDATE lab SET projector=0 WHERE room = 430;";
                MySqlConnection con = new MySqlConnection("host=csdatabase.eku.edu;user=naegle;password=NLHFQB;database=naegle;SslMode=none");
                MySqlCommand cmd = new MySqlCommand(sql, con);
                try
                {
                ...
                projector.Text = "Projector: Unavailble";
            }
            else
            {
                string sql = "UPDATE lab SET projector=1 WHERE room = 430;";
                MySqlConnection con = new MySqlConnection("host=csdatabase.eku.edu;user=naegle;password=NLHFQB;database=naegle;SslMode=none");
                MySqlCommand cmd = new MySqlCommand(sql, con);
                try
                {
